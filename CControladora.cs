                ...
                switch (OPCION)
                {
                    case 'A':
                        ...
                        if (torneo.BuscarJugador(DNI) == null)
                        {
                            ...
                            if (jugador.CalcularEdad())
                            {
                                torneo.AgregarJugador(jugador);
                                CInterfaz.MostrarInfo("SE REGISTRO CORRECTAMENTE EL JUGADOR");
                            }
                            else CInterfaz.MostrarInfo("EL JUGADOR NO SE PUDO AGREGAR YA QUE NO ENTRA EN EL RANGO DE EDAD");
                        }
                    ...
                    case 'D':
                        ...
                        {
                            NOM = torneo.BuscarEquipo(ID).GetNombre();
                            string NOMJ = torneo.BuscarJugador(DNI).GetApellido() + " " + torneo.BuscarJugador(DNI).GetNombre();
                            CInterfaz.MostrarInfo("SE AGREGO EL JUGADOR "  + NOMJ + " AL EQUIPO " + NOM + " CORRECTAMENTE");
                        }
                    ...
                    case 'F':
                        ...
                        {
                            CInterfaz.MostrarInfo("NO EXISTE EQUIPO CON ESE CODIGO IDENTIFICADOR");
                        }
                        break;
                    case 'G':
                        DNI = CInterfaz.PedirDato("el DNI ");
                        ...
                        {
                            CInterfaz.MostrarInfo("SE ELIMINO AL JUGADOR CORRECTAMENTE");
                        }
                        else if (torneo.BuscarJugador(DNI) == null)
                        {
                            CInterfaz.MostrarInfo("EL JUGADOR NO EXISTE");
                        }
                        else CInterfaz.MostrarInfo("NO SE PUDO ELIMINAR EL JUGADOR");
                        break;
                    case 'H':
